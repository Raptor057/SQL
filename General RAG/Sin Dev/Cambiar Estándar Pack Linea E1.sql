...
WHERE is_stoped = 0 AND is_running = 1 AND is_finished = 0 AND  [codew] = 'W08283774'
ORDER BY id DESC
...
WHERE is_stoped = 0 AND is_running = 1 AND is_finished = 0 AND [codew] = 'W08283774' -- aqui va el numero de orden 
